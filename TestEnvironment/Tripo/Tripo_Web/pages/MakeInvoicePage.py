...
# 百度搜索page
class MakeInvoicePage(BasePage):
    # 元素集
    # 发票
    ...
    def choice_invoice_to_xo_item(self):
        self.cssclick(self.fieldbooking_invoice_item_xo_item)
        self.cssclick(self.fieldbooking_invoice_item_xo_confirm)
        self.newHandle()
        # time.sleep(1000)
