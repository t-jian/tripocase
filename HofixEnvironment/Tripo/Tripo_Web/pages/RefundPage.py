...
class RefundPage(BasePage):
    ...
    fieldbooking_invoice_item_refund_fare = "/html/body/div[1]/div/div/div[2]/div/div[2]/div/div/div/div/div/table/tbody/tr/td[6]/div/div/div/div[2]/input"
    ...
    # 退款的頁面
    def refund(self, refund_fare, refund_bankchage, refund_creditchage):
        self.xpathsend(self.fieldbooking_invoice_item_refund_fare, refund_fare)

        self.cssclick(self.refund_way)
        self.cssclick(self.refund_waydefault)
        # self.xpathsend(self.fieldrefund_bankchage, refund_bankchage)
        # self.xpathsend(self.fieldrefund_creditchage, refund_creditchage)
        self.cssclick(self.fieldrefund_comfirm)
        self.newHandle()
