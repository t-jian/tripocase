...
class AddenquiryPage(BasePage):
    ...
    # 弹出客户栏输入客户姓名
    fieldXO_popcustomer = '//*[@id="content"]/div/form/div[1]/div[1]/div[2]/div/span/div/div/div[2]/div[1]/div[1]/span/span/input'
    # 搜索客户按钮
    fieldXO_popcustomer_select_button = '//*[@id="content"]/div/form/div[1]/div[1]/div[2]/div/span/div/div/div[2]/div[1]/div[1]/span/span/span[2]/span/i'
    ...
    fieldxo_next = "#modal-footer > button.PublicButton.ant-btn.ant-btn-primary"
    ...
    # 筛选客户
    def risebooking_select(self, textuser_name):
        # 点击客户栏位
        self.cssclick(self.fieldxo_popustomer)
        # 输入客户信息
        self.xpathsend(self.fieldXO_popcustomer, textuser_name)
        # 点击搜索按钮
        self.xpathclick(self.fieldXO_popcustomer_select_button)
        # 选择筛选的第一个
        self.cssclick(self.fieldxo_customer)
        # 进入下一页
        self.cssclick(self.fieldxo_next)
