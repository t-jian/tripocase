...
class TestInvoice:
    ...
    def test_createinvoice(self, driver, caseinfo):
        ...
        # 篩選客戶
        c.create_invoice(caseinfo["textpassager_name"], caseinfo["textdiscount"])
    ...
    def test_othercharge(self, driver, caseinfo2):
        f = QuotationPage(driver)
        f.create_other(caseinfo2["subscript"], caseinfo2["textothercharge_invoice"], caseinfo2["textothercharge_xo"], caseinfo2["textothercharge_unit"], caseinfo2["textothercharge_remark"])
    ...
    def test_group(self, driver, caseinfo2):
        ...
        f.groupkuiji(caseinfo2["textgroupname"], caseinfo2["textgroupcontacts"], caseinfo2["textgroupdescription"], caseinfo2["textgroupremark"], caseinfo2["textnumber"])
