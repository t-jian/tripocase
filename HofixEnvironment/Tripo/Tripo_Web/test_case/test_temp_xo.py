...
class TestInvoice:
    ...
    @pytest.mark.parametrize("caseinfo",
                             read_testcase("test_case", "\datas\quotation_rise.yaml"))
    def test_xo_to_invoice(self, driver, caseinfo):
    ...
    @pytest.mark.parametrize("caseinfo",
                             read_testcase("test_case", "\datas\quotation_rise.yaml"))
    def test_xo_to_quotation(self, driver, caseinfo):
        f = LeadlisteningPage(driver)
        f.printout_booking()
    ...
    def test_xo_to_receipt(self, driver, caseinfo):
        f = LeadlisteningPage(driver)
        f.printout_booking()
        f.risexo_receipt()
    ...
    def test_xo_to_refund(self, driver, caseinfo):
        f = LeadlisteningPage(driver)
        f.printout_booking()
        f.risexo_refund()
        d = RefundPage(driver)
    ...
    def test_xo_to_refundapplication(self, driver, caseinfo):
        f = LeadlisteningPage(driver)
        f.printout_booking()
        f.risexo_refundapplication()
